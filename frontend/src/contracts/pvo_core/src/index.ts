...
export const networks = {
  testnet: {
    ...
    contractId: "CAJHYJL5E6IPHMYMCODTI5PBLK4TNN2YCT34KAUBIFIL4SJSQW5MVNOD",
  }
} as const
...
export interface Client {
   ...
   */
  create_pvo: ({creator, title, description, funding_agency, contractor, project_manager, department, municipality, total_budget, fund_source}: {creator: string, title: string, description: string, funding_agency: string, contractor: string, project_manager: string, department: string, municipality: string, total_budget: i128, fund_source: string}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAHZ2V0X3B2bwAAAAABAAAAAAAAAAZwdm9faWQAAAAAAAQAAAABAAAD6AAAB9AAAAARUHVibGljVmFsdWVPYmplY3QAAAA=",
        ...
        "",
        ...
        "",
